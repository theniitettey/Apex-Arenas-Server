...
/**
 * Indexes:
 * - Compound: parent_type + parent_id (for fetching comments on an entity)
 * - author_id
 * - parent_comment_id (for fetching replies)
 * - status
 * - created_at
 * - Compound: parent_type + parent_id + status + created_at
 */